...
files = ['/data/datasets/rishi/csv_store/train.csv', '/data/datasets/rishi/csv_store/valid.csv', '/data/datasets/rishi/csv_store/test.csv']
for file in files:
    df = pd.read_csv(file)
...
train_ids, temp_ids = train_test_split(unique_patient_ids, test_size=0.4, random_state=seed)
...
train_data.to_csv('/data/datasets/rishi/csv_store/stratified_train_seed3.csv', index=False)
valid_data.to_csv('/data/datasets/rishi/csv_store/stratified_valid_seed3.csv', index=False)
test_data.to_csv('/data/datasets/rishi/csv_store/stratified_test_seed3.csv', index=False)
